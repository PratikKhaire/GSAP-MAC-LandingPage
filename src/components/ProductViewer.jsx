...
const ProductViewer = () => {
    ...
    const isMobaile = useMediaQuery({  query:'(max-width:1024px'})
  return (
    <section id='product-viewer'>
        <h2>Take a closer look</h2>
        <div className=' controls'>
            <p className=' info'> Macbook Pro | Available in 14" & 16"  </p>
  ...
  {/* <Box  position={[0,1,0]} scale={15 * scale}  material-color={color}/> */}
